export class Collection<Key, Value> extends Map<Key, Value> {
    ...
    public [Symbol.toStringTag]: string = 'Collection';

    public static from<Key, Value>(iterable: Iterable<[Key, Value]>): Collection<Key, Value> {
        return new Collection(iterable);
    };

    public static fromArray<Key, Value>(array: [Key, Value][]): Collection<Key, Value> {
        return new Collection(array);
    };

    public static fromPairs<Key, Value>(pairs: [Key, Value][]): Collection<Key, Value> {
